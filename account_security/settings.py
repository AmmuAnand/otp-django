"""
Django settings for account_security project.
...
SECRET_KEY = '!@v)i0w+*@ld2tsr#l-e6-zp$a(k*%qt68+ago0i(yn6z9g35_'
...
ROOT_URLCONF = 'account_security.urls'
...
WSGI_APPLICATION = 'account_security.wsgi.application'
